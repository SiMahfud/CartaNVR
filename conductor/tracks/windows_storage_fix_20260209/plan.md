...
- [~] Task: Install `systeminformation` dependency.
...
- [ ] Task: Implement a utility function in `lib/utils.js` (or similar) to abstract drive listing using `systeminformation`.
