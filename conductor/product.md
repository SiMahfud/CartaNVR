...
- **Multi-Server Federation:** Connect multiple NVR instances to view cameras, recordings, and system health in a single unified dashboard.
...
- **Storage Management:** Efficient circular recording that automatically cleans up old footage to prevent disk space exhaustion, with an enhanced directory browser that provides real-time disk space information.
